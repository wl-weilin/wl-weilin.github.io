...
(2) AMS的开发项目：运营商定制ROM，手机和PC的多屏协同，折叠屏连续性及打点，平行窗口等。
...
(6) WindowManager：窗口显示流程、平行窗口等，以及常见问题的处理；

(7) Binder通信：Slow Binder，服务端问题，跨进程抛出异常等；

(8) SystemUI：多任务显示、锁屏、通知等问题；

(9) Settings：部分问题的处理，如数据库相关的ContentProvider，Activity相关的稳定性问题等。
